...
var Options_1 = __webpack_require__(/*! ../../lib/Options */ "../lib/Options.js");
var optionsElement = document.getElementById('options');
var query = queryString.parse(location.search);
// init options input
Object.keys(Options_1.defaultOptions).forEach(function (optionKey) {
    ...
    input.value = typeof query[optionKey] !== 'undefined' ? query[optionKey] : Options_1.defaultOptions[optionKey];
